...
export class PropertyControllerBase {
  ...
  @common.Get("/properties/available")
  ...
  async GetAvailableProperties(
    ...
    return this.service.GetAvailableProperties(body);
  }

  @common.Get("/properties/:id/details")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetPropertyDetails(
    ...
    return this.service.GetPropertyDetails(body);
  }
}
