...
export class AgentAssignmentControllerBase {
  ...
  @common.Post("/agent-assignments/:id/complete")
  ...
  async CompleteAgentAssignment(
    @common.Body()
    body: string
  ): Promise<string> {
    return this.service.CompleteAgentAssignment(body);
  }

  @common.Get("/agent-assignments/current")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetCurrentAgentAssignments(
    @common.Body()
    body: string
  ): Promise<string> {
    return this.service.GetCurrentAgentAssignments(body);
  }
}
